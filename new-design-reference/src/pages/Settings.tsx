      ...
      <div className="container mx-auto px-6 py-12 max-w-5xl">
        ...
        <div className="space-y-8">
          ...
          <section className="card-rfp">
            ...
            <div className="mt-6">
              <Button className="btn-primary w-auto">Save Profile</Button>
            </div>
          </section>

          {/* Lead Sources */}
          <section className="card-rfp">
            <h2 className="text-xl font-black text-foreground mb-2">Lead Sources</h2>
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-sketch">
                <thead>
                  <tr>
                    <th className="text-left py-3 px-4 text-sm font-bold text-foreground">Source Name</th>
                    <th className="text-left py-3 px-4 text-sm font-bold text-foreground">URL</th>
                    <th className="text-left py-3 px-4 text-sm font-bold text-foreground">Tags</th>
                    <th className="text-left py-3 px-4 text-sm font-bold text-foreground">Active</th>
            ...
            <div className="flex gap-3 mt-6">
              <Button className="btn-secondary w-auto" onClick={handleAddSource}>
                <Plus className="w-4 h-4 mr-2" />
                Add Source
              </Button>
              <Button className="btn-primary w-auto">Save Sources</Button>
            </div>
          </section>

          {/* Manual Lead Upload */}
          <section className="card-rfp">
            <h2 className="text-xl font-black text-foreground mb-6">Manual Lead Upload</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-2">
                <Label htmlFor="rfpId" className="font-bold">RFP ID</Label>
                <Input
                  id="rfpId"
              ...
              <div className="space-y-2">
                <Label htmlFor="leadTitle" className="font-bold">Title</Label>
                <Input
                  id="leadTitle"
              ...
              <div className="space-y-2">
                <Label htmlFor="leadBuyer" className="font-bold">Buyer / Agency</Label>
                <Input
                  id="leadBuyer"
              ...
              <div className="space-y-2">
                <Label htmlFor="leadDeadline" className="font-bold">Submission Deadline</Label>
                <Input
                  id="leadDeadline"
                  type="date"
              ...
              <div className="space-y-2 md:col-span-2">
                <Label htmlFor="leadUrl" className="font-bold">Link / URL</Label>
                <Input
                  id="leadUrl"
            ...
            <div className="flex gap-3 mb-8">
              ...
              <Button className="btn-primary w-auto">Save Lead</Button>
            </div>
            
            {/* Recently Added Leads */}
            <div>
              <h3 className="text-sm font-bold text-foreground mb-3">Recently Added Leads</h3>
              <div className="space-y-2">
                {mockRecentLeads.map((lead) => (
                  <div key={lead.id} className="flex items-center justify-between p-3 bg-warning/10 border-2 border-foreground">
                    <div>
                      <span className="text-sm font-bold text-foreground">{lead.id}</span>
          ...
          {/* Stock & SKU Settings */}
          <section className="card-rfp">
            <h2 className="text-xl font-black text-foreground mb-6">Stock & SKU Settings</h2>
            
            <div className="overflow-x-auto">
              <table className="w-full table-sketch">
                <thead>
                  <tr>
                    <th className="text-left py-3 px-4 text-sm font-bold text-foreground">SKU</th>
                    <th className="text-left py-3 px-4 text-sm font-bold text-foreground">Description</th>
                    <th className="text-left py-3 px-4 text-sm font-bold text-foreground">Stock Available</th>
                    <th className="text-left py-3 px-4 text-sm font-bold text-foreground">Rack / Warehouse ID</th>
                    <th className="text-left py-3 px-4 text-sm font-bold text-foreground">Actions</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div className="flex gap-3 mt-6">
              <Button className="btn-secondary w-auto" onClick={handleAddSKU}>
                <Plus className="w-4 h-4 mr-2" />
                Add SKU
              </Button>
              <Button className="btn-primary w-auto">Save Stock</Button>
            </div>
          </section>
        </div>
      </div>
