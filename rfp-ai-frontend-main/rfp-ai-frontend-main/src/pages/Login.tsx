...
import { Sparkles, Users, Package, Target } from "lucide-react";
...
const Login = () => {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center bg-background-light overflow-hidden">
      ...
      <header className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-4 z-10">
        <nav className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/rfp/1" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
              RFP Detail
            </Link>
      ...
      {/* Main content */}
      <main className="flex-grow w-full max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center z-10 py-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="bg-background-light px-2 text-muted-foreground">Or</span>
                    </div>
                  </div>
